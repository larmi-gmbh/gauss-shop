...
{foreach from=$Pages item=positions name="pagingLoop" key=page}
    ...
    <tr>
        ...
        {/block}
        <!-- Anzeige Einheitengröße -->
        {block name="document_index_table_pack_unit"}
            <td align="right" width="5%" valign="top">
              {$position.attr20}
            </td>
        {/block}
